...
namespace EnvironmentalMonitor.Support.Instruction.Out.Response
{
    ...
    /// 设置时间成功应答指令
    /// </summary>
    public class TimeSuccessInstruction : EnvironmentalMonitor.Support.Instruction.AbstractInstruction
    {
        ...
        public TimeSuccessInstruction(DateTime time)
        {
