...
namespace EnvironmentalMonitor.Support.Instruction.In.Request
{
    ...
    /// 环境数据报警指令
    /// </summary>
    public class AlarmInstruction : EnvironmentalMonitor.Support.Instruction.AbstractInstruction
    {
        ...
        public AlarmInstruction(List<Detector> detectors)
        {
            if (detectors != null)
            {
                int address = 0;
        ...
        public override List<AbstractInstruction> ErrorAnswer()
        {
            ...
            Response.AlarmErrorInstruction instruction = new Response.AlarmErrorInstruction();
        ...
        {
            List<AbstractInstruction> results = new List<AbstractInstruction>();
            Response.AlarmSuccessInstruction instruction = new Response.AlarmSuccessInstruction();
            results.Add(instruction);
            return results;
        }
    }
