<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="EnvironmentalMonitor.Website.Environmentals.DetectorTypes.Update" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" align="left">
                                            <asp:Image ID="ImageNormal" runat="server" Height="64px" Width="64px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td colspan="2" align="left">
                                            <asp:Image ID="ImageError" runat="server" Height="64px" Width="64px" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
