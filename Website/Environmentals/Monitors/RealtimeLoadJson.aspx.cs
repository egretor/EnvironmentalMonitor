...
{
    public partial class RealtimeLoadJson : EnvironmentalMonitor.Website.Abstracts.AbstractSecurityPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<Detector> modules = business.QueryDataCacheByMachine(machineId);
