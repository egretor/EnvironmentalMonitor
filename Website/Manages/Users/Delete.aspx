<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="EnvironmentalMonitor.Website.Manages.Users.Delete" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:CheckBoxList ID="CheckBoxListUsers" runat="server" RepeatLayout="Flow">
                                            </asp:CheckBoxList>
                                        </td>
                                        <td align="right">
                                        </td>
